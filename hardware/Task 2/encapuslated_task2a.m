...
%move block 1
block1grabpre = [9*pase 0 pre_pos];
block1grab = block1grabpre;
block1grab(3)=block1grab(3)-dropdown;
block1droppre = [0.005 6*pase pre_pos];
block1drop = block1droppre;
block1drop(3) = block1drop(3)-dropdown;

%move block 2
block2grabpre = [7*pase -7*pase pre_pos];
block2grab = block2grabpre;
block2grab(3)=block2grab(3)-dropdown;
block2droppre = [6*pase+0.003 6*pase-0.003 pre_pos];
block2drop = block2droppre;
block2drop(3) = block2drop(3)-dropdown;

%for not to collide ground when turning gripper
block2gripperriser = block2droppre;
block2gripperriser(3)=block2gripperriser(3)+0.126;


%move block 3
block3grabpre = [3*pase -8*pase pre_pos-0.005];
block3grab = block3grabpre;
block3grab(3)=block3grab(3)-dropdown+0.01;
block3droppre = [4*pase 0 pre_pos];
block3drop = block3droppre;
block3drop(3) = block3drop(3)-dropdown-0.01;
...
% move block 1
executePathSegment('startCoord', intial2block1, 'endCoord', block1grabpre, 'planType', 3, 'NPoints', 20, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block1grabpre, 'endCoord', block1grab, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
gripperClose();
executePathSegment('startCoord', block1grab, 'endCoord', block1grabpre, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block1grabpre, 'endCoord', block1droppre, 'planType', 3, 'NPoints', 20, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block1droppre, 'endCoord', block1drop, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
gripperOpenSlow();
executePathSegment('startCoord', block1drop, 'endCoord', block1droppre, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);



% move block 2
executePathSegment('startCoord', block1droppre, 'endCoord', block2grabpre, 'planType', 3, 'NPoints', 30, 'TotalTime', 0.1, 'Degree', 0);
...
executePathSegment('startCoord', block2grabpre, 'endCoord', block2droppre, 'planType', 3, 'NPoints', 20, 'TotalTime', 0.1, 'Degree', 0);
executePathSegment('startCoord', block2droppre, 'endCoord', block2drop, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 0);
gripperOpenSlow();
executePathSegment('startCoord', block2drop, 'endCoord', block2droppre, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 0);
%turn gripper to 80 degree
executePathSegment('startCoord', block2droppre, 'endCoord', block2gripperriser, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 0);
...
% move block 3
executePathSegment('startCoord', block2droppre, 'endCoord', block3grabpre, 'planType', 3, 'NPoints', 30, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block3grabpre, 'endCoord', block3grab, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
gripperClose();
executePathSegment('startCoord', block3grab, 'endCoord', block3grabpre, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block3grabpre, 'endCoord', block3droppre, 'planType', 3, 'NPoints', 20, 'TotalTime', 0.1, 'Degree', 60);
executePathSegment('startCoord', block3droppre, 'endCoord', block3drop, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 60);
gripperOpenSlow();
executePathSegment('startCoord', block3drop, 'endCoord', block3droppre, 'planType', 3, 'NPoints', 10, 'TotalTime', 0.1, 'Degree', 607);
